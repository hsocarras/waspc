...
TEST(WASPC_RUNTIME_RUNTIME, RUNTIME_READ_MODULE) {
    ...
    ASSERT_NE(module_state, nullptr) << "WpRuntimeReadModule returned null";
    ASSERT_EQ(module_state->type, WP_OBJECT_MODULE_STATE) << "WpRuntimeReadModule did not return a WpModuleState object";
